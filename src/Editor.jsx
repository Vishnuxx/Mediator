  ...
  return (
    <section className={`w-[100%] h-[100%] flex flex-col`}>
      ...
      <Split className={`bg-[#17171700] h-fill`} renderBar={renderbar}>
        <div
          className={`w-[250px] min-w-[200px] max-w-[500px] bg-[${background}]`}
        >
          test
        </div>
        <div className={`h-[100%] min-w-[80px]  flex flex-col flex-1 bg-[${background}]`}>
          <TabView></TabView>
          <Split mode="horizontal" renderBar={renderbar} className=" h-[100%] ">
            <div className={`h-[100%] w-[100%] bg-[${background}]`}>
              <RequestPanel></RequestPanel>
            </div>
            <div
              // style={{ minWidth: 80, flex: 1 }}
              className={`h-[100%] w-[100%] bg-[${background}]`}
            >
              {/* <RequestPanel></RequestPanel> */}
            </div>
          </Split>
